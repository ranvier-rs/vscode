...
11. 단축키 충돌 시 VSCode `keybindings.json`에서 팀 규칙으로 재정의할 수 있습니다(배포 가이드 [Keyboard Shortcuts (Team Override)](../docs/03_guides/vscode_extension_deploy.md#8-keyboard-shortcuts-team-override) 참고).
...
| 12 | [Profile Template Open Commands](../docs/03_guides/vscode_extension_deploy.md#12-profile-template-open-commands-os-variants) | OS별 프로필 파일 열기 명령 |
| 13 | [Command Name Localization](../docs/03_guides/vscode_extension_deploy.md#13-command-name-localization-note-enko) | EN/KO 명령 이름 대응표 |
