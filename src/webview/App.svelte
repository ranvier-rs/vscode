    ...
    nodes.set(
      sourceNodes.map((node) => {
        ...
        const isActive = Boolean(
          sourceFile && normalizedActive && sourceFile === normalizedActive,
        );
        ...
        ? format(
            ...
            diagnosticsUpdatedAt
              ? format(
                  ...
                  new Date(diagnosticsUpdatedAt).toLocaleTimeString(locale),
                )
              : "",
          )
        : "";
